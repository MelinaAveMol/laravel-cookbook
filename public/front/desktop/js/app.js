...
/* harmony export */   "renderFilter": () => (/* binding */ renderFilter)
/* harmony export */ });
...
var renderFilter = function renderFilter() {
  var formContainer = document.querySelector('.front-form');
  var dispatchButton = document.querySelector('.filter-button');
  ...
  if (dispatchButton) {
    dispatchButton.addEventListener("click", function (event) {
...
var renderProduct = function renderProduct() {
  ...
  var productButtons = document.querySelectorAll('.shop-articles-sections-cards-content-button');
...
/* harmony import */ var _product_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./product.js */ "./resources/js/front/desktop/product.js");
/* harmony import */ var _filter_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./filter.js */ "./resources/js/front/desktop/filter.js");
...
(0,_plusminusbutton_js__WEBPACK_IMPORTED_MODULE_0__.plusMinusButton)();
(0,_renderAccordion_js__WEBPACK_IMPORTED_MODULE_1__.renderAccordion)();
(0,_product_js__WEBPACK_IMPORTED_MODULE_2__.renderProduct)();
(0,_filter_js__WEBPACK_IMPORTED_MODULE_3__.renderFilter)(); // renderTabs();
// tabs();
// addToTrolley();
// renderMenu();
})();
